...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.team_label.setMinimumSize(QtCore.QSize(0, 0))
        self.team_label.setObjectName("team_label")
        self.horizontalLayout_2.addWidget(self.team_label, 0, QtCore.Qt.AlignLeft)
        self.team_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(100)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.team_line_edit.sizePolicy().hasHeightForWidth())
        self.team_line_edit.setSizePolicy(sizePolicy)
        self.team_line_edit.setMinimumSize(QtCore.QSize(0, 0))
        self.team_line_edit.setObjectName("team_line_edit")
        self.horizontalLayout_2.addWidget(self.team_line_edit)
        ...
        self.autoSearch = QtWidgets.QLineEdit(self.centralwidget)
        self.autoSearch.setPlaceholderText("")
        self.autoSearch.setObjectName("autoSearch")
        self.verticalLayout.addWidget(self.autoSearch)
